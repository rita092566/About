...
})({"dIugA":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a9adf04df6fae50c";
...
},{}],"7R80h":[function(require,module,exports) {
var _utils = require("../utils");
var _repeatTextScrollFx = require("./repeatTextScrollFx");
// Preload images and fonts and remove loader
(0, _utils.preloadFonts)("fxx5dng").then(()=>{
    // Apply the effect on these elements
    document.querySelectorAll("[data-text-rep]").forEach((textEl)=>{
        new (0, _repeatTextScrollFx.RepeatTextScrollFx)(textEl);
    });
    document.body.classList.remove("loading");
});

},{"../utils":"72Dku","./repeatTextScrollFx":"dNFX6"}],"72Dku":[function(require,module,exports) {
...
},{}],"dNFX6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Class representing an element with multiple text child elements that translate up/down when scrolling
 */ parcelHelpers.export(exports, "RepeatTextScrollFx", ()=>RepeatTextScrollFx);
var _utils = require("../utils");
...
class RepeatTextScrollFx {
     ...
     */ setBoundaries() {
        ...
        const paddingBottomMarginTop = (0, _utils.getHeight)(this.DOM.el) * Math.floor(this.totalWords / 2) * this.tyIncrement / 100;
     ...
     */ createScrollTimeline() {
        this.scrollTimeline = (0, _gsap.gsap).timeline({
            paused: true
        }).to(this.DOM.words, {
            duration: 1,
            ease: "sine.inOut",
     ...
     */ createObserver() {
        ...
        this.observer = new IntersectionObserver((entry)=>{
            if (entry[0].intersectionRatio > 0) {
                ...
                (0, _gsap.gsap).ticker.add(this.progressTween);
            } else if (this.isLoaded) (0, _gsap.gsap).ticker.remove(this.progressTween);
            else {
                this.isLoaded = true;
                // add and remove immediately
                (0, _gsap.gsap).ticker.add(this.progressTween, true);
            }
        }, observerOptions);
        this.progressTween = ()=>{
...
},{"../utils":"72Dku","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dIugA","7R80h"], "7R80h", "parcelRequire7cb3")

//# sourceMappingURL=index4.f6fae50c.js.map
